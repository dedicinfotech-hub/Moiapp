...
export const metadata = {
  title: 'Privacy Policy – Moi PassBook',
  description: 'Learn how Moi PassBook collects, uses, stores, and protects your personal information.',
};

const sections = [
  {
    title: '1. About Moi PassBook',
    content:
      'Moi PassBook is a digital platform designed for Tamil family celebrations, allowing users to create events and send or receive Moi Panam securely through digital payment methods.',
  ...
  },
  {
    ...
    content: 'Moi PassBook does not store:',
    list: [
  ...
  },
  {
    ...
    content: 'Moi PassBook may use cookies, analytics tools, and similar technologies to:',
    list: [
  ...
  },
  {
    ...
    content: 'Moi PassBook is intended for users aged 18 years or older.',
    note: 'We do not knowingly collect personal information from children without appropriate consent.',
  },
  {
    title: '10. Third-Party Services',
    content: 'Moi PassBook may integrate with trusted third-party services including:',
    list: [
  ...
  },
  {
    ...
    list: [
      ...
      'Continued use of Moi PassBook indicates acceptance of the updated Privacy Policy.',
    ],
  },
];
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-tn-yellow-bg via-tn-yellow-light to-tn-yellow-bg border-b border-tn-gold-border py-14 px-4">
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <p className="text-tn-muted text-sm lg:text-base leading-relaxed max-w-2xl mx-auto">
            Welcome to Moi PassBook. Your privacy is important to us. This Privacy Policy explains how
            we collect, use, store, and protect your personal information when you use our
            application and services.
          </p>
          <p className="text-tn-subtle text-xs mt-3">
            By accessing or using Moi PassBook, you agree to the practices described in this Privacy Policy.
          </p>
        </div>
      </div>

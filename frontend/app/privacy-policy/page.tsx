            ...
            <div key={section.title} className="px-6 lg:px-8 py-6">
              ...
              <div className="pl-10">
                ...
                {'groups' in section && section.groups && (
                  <div className="mt-4 space-y-4">
                    {section.groups.map((group) => (
                      <div key={group.label} className="bg-[#FFFCF5] border border-[#FFE082] rounded-xl px-4 py-3">
                        {group.intro && (
                          <p className="text-xs text-[#666] mb-1">{group.intro}</p>
                        )}
                        ...
                        {group.note && (
                          <p className="text-xs text-[#888] mt-2 italic">{group.note}</p>
                        )}
                      </div>
                    ))}
                  </div>
                ...
                {'note' in section && !('groups' in section) && section.note && (
                  <div className="mt-3 flex items-start gap-2 bg-[#FFFCF5] border border-[#FFE082] rounded-lg px-3 py-2">
            ...
            <div className="pl-10">
              ...
              <div className="bg-[#FFFCF5] border border-[#FFE082] rounded-xl px-5 py-4 space-y-3">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <a href="mailto:support@moiapp.in" className="text-sm text-[#B8860B] font-semibold hover:underline">
                    support@moiapp.in
                  </a>
                </div>
                <div className="flex items-center gap-2.5">

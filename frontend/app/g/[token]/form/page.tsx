        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              ...
              { id: 'gift', label: 'Others', icon: 'gift' as IconName },
            ].map((t) => (
              <button key={t.id} type="button" onClick={() => update('gift_type', t.id)} className={`p-2 rounded-xl border-2 text-center ${form.gift_type === t.id ? 'border-[#7C3AED] bg-[#F5F3FF]' : 'border-[#E5E7EB] bg-white'}`}>
          ...
          <div className="bg-[#F5F3FF] rounded-xl p-3 flex gap-2 text-[11px] text-[#4B218B]">

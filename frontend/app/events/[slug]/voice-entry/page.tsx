...
export default function VoiceEntryScreen() {
  ...
  return (
    <HostEntryShell slug={slug} title="Voice Entry" subtitle="Speak the contributor details and amount. We'll convert it to text for you to review and save." activeTab="voice" onBack={() => router.push(`/events/${slug}/entries`)}>

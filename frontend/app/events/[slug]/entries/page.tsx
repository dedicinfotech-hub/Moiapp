...
export default function MoiEntriesListScreen() {
  ...
  return (
    <HostEntryShell slug={slug} title="Moi Entries" activeTab="entries" onBack={() => router.push(`/events/${slug}/dashboard`)}>
            ...
            <div key={entry.id} className={`flex items-center gap-3 px-4 py-3 ${i > 0 ? 'border-t border-[#F3F4F6]' : ''}`}>
              ...
              <div className="flex flex-col gap-1 shrink-0">
                ...
                <button
                  type="button"
                  onClick={() => {
                    if (confirm('Delete this entry?')) confirmDelete(entry.id);
                  }}
      ...
      <div className="fixed bottom-[68px] left-0 right-0 px-4 flex gap-2 bg-gradient-to-t from-[#F9FAFB] via-[#F9FAFB] to-transparent pt-4 pb-3">
        <button type="button" onClick={() => router.push(`/events/${slug}/moi-entry`)} className="flex-1 h-12 bg-[#FFC107] text-white rounded-xl font-semibold text-sm flex items-center justify-center gap-1">
          <span className="text-lg">+</span> Manual
        </button>
        <button type="button" onClick={() => router.push(`/events/${slug}/voice-entry`)} className="flex-1 h-12 bg-[#3B82F6] text-white rounded-xl font-semibold text-sm flex items-center justify-center gap-1">
        ...
        <button type="button" onClick={() => router.push(`/events/${slug}/gift-entry`)} className="flex-1 h-12 bg-[#F97316] text-white rounded-xl font-semibold text-sm flex items-center justify-center gap-1">
        ...
        <button type="button" onClick={handleExportCSV} className="flex-1 h-12 border border-[#E5E7EB] bg-white rounded-xl font-semibold text-xs text-[#6B7280] flex items-center justify-center gap-1">

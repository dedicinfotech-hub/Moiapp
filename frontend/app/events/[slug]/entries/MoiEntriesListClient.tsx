...
export default function MoiEntriesListScreen() {
  ...
  return (
    <HostEntryShell slug={slug} title="Moi Entries" activeTab="entries" onBack={() => router.push(`/events/${slug}/dashboard`)} sidebarOverride="closed">
      ...
      <div className="bottom-[68px] left-0 right-0 px-4 bg-gradient-to-t from-[#F9FAFB] via-[#F9FAFB] to-transparent pt-4 pb-3">
        <div className="max-w-lg mx-auto grid grid-cols-2 md:grid-cols-4 gap-2">
          <button type="button" onClick={() => router.push(`/events/${slug}/moi-entry`)} className="h-12 bg-[#FFC107] text-white rounded-xl font-semibold text-sm flex items-center justify-center gap-1">
            <span className="text-lg">+</span> Manual
          </button>
          <button type="button" onClick={() => router.push(`/events/${slug}/voice-entry`)} className="h-12 bg-[#3B82F6] text-white rounded-xl font-semibold text-sm flex items-center justify-center gap-1">
          ...
          <button type="button" onClick={() => router.push(`/events/${slug}/gift-entry`)} className="h-12 bg-[#F97316] text-white rounded-xl font-semibold text-sm flex items-center justify-center gap-1">
          ...
          <button type="button" onClick={handleExportCSV} className="h-12 border border-[#E5E7EB] bg-white rounded-xl font-semibold text-xs text-[#6B7280] flex items-center justify-center gap-1">

  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm text-tn-muted">{guests.length} guests</span>
      </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-tn-border bg-tn-light text-left">
                    ...
                    <th className="px-4 py-3 text-xs font-semibold text-tn-muted uppercase tracking-wide text-center hidden sm:table-cell">Entries</th>
                    <th className="px-4 py-3 text-xs font-semibold text-tn-muted uppercase tracking-wide text-center hidden md:table-cell">Events</th>
                    <th className="px-4 py-3 text-xs font-semibold text-tn-muted uppercase tracking-wide text-right hidden lg:table-cell">Last Seen</th>
                ...
                <tbody className="divide-y divide-tn-border">
                  {paginatedGuests.map((g, i) => (
                    <tr key={g.name} className="hover:bg-tn-light transition-colors">
                      ...
                      <td className="px-4 py-3 text-center text-tn-muted hidden sm:table-cell">{g.count}</td>
                      <td className="px-4 py-3 text-center text-tn-muted hidden md:table-cell">{g.eventIds.size}</td>
                      <td className="px-4 py-3 text-right text-tn-muted text-xs hidden lg:table-cell whitespace-nowrap">
